  ...
  head: () => ({
    meta: [
      { title: "Réalisations — Malaaji Solar" },
      {
        name: "description",
        content:
          "Découvrez nos installations solaires à travers le Sénégal : Koki Diop, Saint-Louis, Sinthiou Bamambé, Kayar et plus.",
      },
      { property: "og:title", content: "Nos réalisations solaires au Sénégal" },
      {
        property: "og:description",
        content:
          "Forages, mini-centrales, kits AIO, batteries Livoltek — déjà installés à travers le Sénégal.",
      },
...
const projects = [
  {
    ...
    loc: "Koki Diop",
    power: "29 kWc",
    desc: "Alimentation d'une pompe électrique pour l'eau potable du village.",
  },
  {
    img: saintLouis,
    ...
    loc: "Saint-Louis",
    power: "5 KVA / 5 kWh",
    desc: "Installation résidentielle Livoltek tout-en-un avec stockage.",
  },
  {
    img: sinthiou,
    title: "Pompe AC/DC 2200 W",
    loc: "Sinthiou Bamambé",
    power: "2.2 kW",
    desc: "Pompage solaire pour l'irrigation et l'agriculture villageoise.",
  },
  {
    img: kayar,
    title: "Kayar FM — 5 KVA / 5 kWh",
    loc: "Kayar",
    power: "5 KVA",
    desc: "Alimentation continue d'une station radio locale.",
  },
  {
    img: centrale,
    title: "Mini-centrale 169 kWc",
    loc: "Site industriel",
    power: "90 KVA / 200 kWh",
    desc: "Installation 2 onduleurs Livoltek + parc batterie pour autonomie totale.",
  },
  {
    img: batteries,
    title: "Parc de stockage lithium",
    loc: "Showroom Thiès",
    power: "Multi-rack",
    desc: "Batteries lithium-ion Livoltek pour projets de grande capacité.",
  },
  {
    img: team,
    ...
    loc: "Sur site client",
    power: "—",
    desc: "Notre équipe technique assure câblage, paramétrage et formation à l'usage.",
  },
  {
    img: stock,
    title: "Stock & logistique",
    loc: "Entrepôt Malaaji",
    power: "—",
    desc: "Disponibilité immédiate de matériel Livoltek certifié.",
  },
];
      ...
      <section className="bg-secondary/40 py-20">
        <div className="container mx-auto px-4 lg:px-8 max-w-5xl">
          ...
          <p className="mt-6 text-lg text-muted-foreground max-w-3xl leading-relaxed">
            De Saint-Louis à Sinthiou Bamambé, en passant par Koki Diop et Kayar — nos installations
            alimentent foyers, villages, commerces et infrastructures.
          </p>
        </div>
      </section>
